...
from LukasKanadeRobust import LucasKanadeAffineRobust
...
# output_video_path = f"../results/lk_affine/{data_name}/output_video_lk_affine.mp4"
output_video_path = f"../results/lk_affine_robust/{data_name}/output_video_lk_affine.mp4"
...
for i in range(numFrames-1):
    ...
    M = LucasKanadeAffineRobust(It, It1, rect,"huber")
    print('M ', M)
    ...
    save_path = "../results/lk_affine_robust/%s/frame%06d.jpg" % (data_name, i+1)
